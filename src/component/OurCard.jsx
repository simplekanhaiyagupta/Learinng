...
<section className="bg-white dark:bg-black bg-[] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        <a href="#" className="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-white dark:text-[#000] hover:bg-blue-200 dark:hover:bg-white">
            <span className="text-xs bg-black rounded-full text-white px-4 py-1.5 me-3">New</span> <span class="text-sm font-medium">Jumbotron component was launched! See what's new</span> 
        ...
        <form className="w-full max-w-md mx-auto">   
            ...
            <div className="relative">
                ...
                <button type="submit" class="text-black absolute end-2.5 bottom-2.5 bg-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-fuchsia-50 dark:hover:bg-green-700 dark:focus:ring-blue-800">Sign up</button>
            </div>
        </form>
    </div>
   </section>
